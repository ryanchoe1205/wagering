...
DATABASES = {
    'default': {
        ...
        'NAME': "/home/user/matt/wagering/db.db" if is_production else 'db.db',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = 'C:/Users/joshua/Programming/wagering/static/'
...
SECRET_KEY = '*5oi5uj^kqfvz8g&8cq^v**5pvq7ollpg8*vbh52cpkdhldsyz'
...
FACEBOOK_APP_ID = '443099615803198'
FACEBOOK_API_SECRET = '1fcfd94bdfe160aa1dfab136f7f30221'