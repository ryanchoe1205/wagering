...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wagers_tournament', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('uuid', self.gf('wagers.fields.UUIDField')(unique=True, max_length=32, blank=True)),
            ('is_open', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('entrance_fee', self.gf('django.db.models.fields.DecimalField')(default=5.0, max_digits=100, decimal_places=10)),
            ('prize_pool', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=100, decimal_places=10)),
        ))
        db.send_create_signal(u'wagers', ['Tournament'])


    def backwards(self, orm):
        # Deleting model 'Tournament'
        db.delete_table(u'wagers_tournament')
