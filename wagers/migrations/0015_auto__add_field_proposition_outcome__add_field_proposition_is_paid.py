...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposition.outcome'
        db.add_column(u'wagers_proposition', 'outcome',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Proposition.is_paid'
        db.add_column(u'wagers_proposition', 'is_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposition.outcome'
        db.delete_column(u'wagers_proposition', 'outcome')

        # Deleting field 'Proposition.is_paid'
        db.delete_column(u'wagers_proposition', 'is_paid')
    ...
    models = {
        ...
        u'wagers.proposition': {
            ...
            'pot': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '100', 'decimal_places': '10'}),
