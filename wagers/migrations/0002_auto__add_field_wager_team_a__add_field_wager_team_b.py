...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wager.team_a'
        db.add_column(u'wagers_wager', 'team_a',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Wager.team_b'
        db.add_column(u'wagers_wager', 'team_b',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wager.team_a'
        db.delete_column(u'wagers_wager', 'team_a')

        # Deleting field 'Wager.team_b'
        db.delete_column(u'wagers_wager', 'team_b')
