...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameSeason'
        db.create_table(u'wagers_gameseason', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('game_type', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal(u'wagers', ['GameSeason'])


    def backwards(self, orm):
        # Deleting model 'GameSeason'
        db.delete_table(u'wagers_gameseason')
    ...
    models = {
        ...
        u'wagers.gameseason': {
            'Meta': {'object_name': 'GameSeason'},
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'game_type': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
