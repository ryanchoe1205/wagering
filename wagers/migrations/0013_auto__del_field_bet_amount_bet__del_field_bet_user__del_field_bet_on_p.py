...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Bet.amount_bet'
        db.delete_column(u'wagers_bet', 'amount_bet')

        # Deleting field 'Bet.user'
        db.delete_column(u'wagers_bet', 'user_id')

        # Deleting field 'Bet.on_prop'
        db.delete_column(u'wagers_bet', 'on_prop_id')

        # Adding field 'Bet.created_by'
        db.add_column(u'wagers_bet', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wagers.Player']),
                      keep_default=False)

        # Adding field 'Bet.credits'
        db.add_column(u'wagers_bet', 'credits',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=100, decimal_places=10),
                      keep_default=False)

        # Adding field 'Bet.proposition'
        db.add_column(u'wagers_bet', 'proposition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wagers.Proposition']),
                      keep_default=False)

        # Adding unique constraint on 'Bet', fields ['proposition', 'created_by']
        db.create_unique(u'wagers_bet', ['proposition_id', 'created_by_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Bet', fields ['proposition', 'created_by']
        db.delete_unique(u'wagers_bet', ['proposition_id', 'created_by_id'])


        # User chose to not deal with backwards NULL issues for 'Bet.amount_bet'
        raise RuntimeError("Cannot reverse this migration. 'Bet.amount_bet' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Bet.user'
        raise RuntimeError("Cannot reverse this migration. 'Bet.user' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Bet.on_prop'
        raise RuntimeError("Cannot reverse this migration. 'Bet.on_prop' and its values cannot be restored.")
        # Deleting field 'Bet.created_by'
        db.delete_column(u'wagers_bet', 'created_by_id')

        # Deleting field 'Bet.credits'
        db.delete_column(u'wagers_bet', 'credits')

        # Deleting field 'Bet.proposition'
        db.delete_column(u'wagers_bet', 'proposition_id')
    ...
    models = {
        ...
        u'wagers.tournament': {
            ...
            'starting_credits': ('django.db.models.fields.DecimalField', [], {'default': '10.0', 'max_digits': '100', 'decimal_places': '10'}),
