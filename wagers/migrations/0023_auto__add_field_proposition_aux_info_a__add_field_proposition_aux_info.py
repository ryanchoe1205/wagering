...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposition.aux_info_a'
        db.add_column(u'wagers_proposition', 'aux_info_a',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Proposition.aux_info_b'
        db.add_column(u'wagers_proposition', 'aux_info_b',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposition.aux_info_a'
        db.delete_column(u'wagers_proposition', 'aux_info_a')

        # Deleting field 'Proposition.aux_info_b'
        db.delete_column(u'wagers_proposition', 'aux_info_b')
    ...
    models = {
        ...
        u'wagers.proposition': {
            ...
            'aux_info_a': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'aux_info_b': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
