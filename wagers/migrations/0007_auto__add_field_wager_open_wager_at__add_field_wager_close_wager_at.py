...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wager.open_wager_at'
        db.add_column(u'wagers_wager', 'open_wager_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Wager.close_wager_at'
        db.add_column(u'wagers_wager', 'close_wager_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wager.open_wager_at'
        db.delete_column(u'wagers_wager', 'open_wager_at')

        # Deleting field 'Wager.close_wager_at'
        db.delete_column(u'wagers_wager', 'close_wager_at')
    ...
    models = {
        ...
        u'wagers.wager': {
            ...
            'close_wager_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_open': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {}),
            'open_wager_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
