...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Proposition.pot'
        db.delete_column(u'wagers_proposition', 'pot')


    def backwards(self, orm):
        # Adding field 'Bet.credits'
        db.add_column(u'wagers_bet', 'credits',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=100, decimal_places=10),
                      keep_default=False)

        # Adding field 'Proposition.pot'
        db.add_column(u'wagers_proposition', 'pot',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=100, decimal_places=10),
                      keep_default=False)
