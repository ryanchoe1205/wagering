...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for prop in orm.Proposition.objects.all():
            if not prop.schedule:
                schedule = orm.Schedule()
                schedule.open_wager_at = prop.open_wager_at
                schedule.close_wager_at = prop.close_wager_at
                schedule.save()
    ...
    def backwards(self, orm):
        ...
        for prop in orm.Propositions.objects.all():
            if prop.schedule:
                prop.oper_waget_at = schedule.open_wager_at
                prop.close_wager_at = schedule_close_wager_at
                prop.save()
