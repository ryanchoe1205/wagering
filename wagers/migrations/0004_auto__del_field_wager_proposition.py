...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Wager.proposition'
        db.delete_column(u'wagers_wager', 'proposition')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Wager.proposition'
        raise RuntimeError("Cannot reverse this migration. 'Wager.proposition' and its values cannot be restored.")
