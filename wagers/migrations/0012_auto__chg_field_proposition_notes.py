...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proposition.notes'
        db.alter_column(u'wagers_proposition', 'notes', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Proposition.notes'
        db.alter_column(u'wagers_proposition', 'notes', self.gf('django.db.models.fields.TextField')())
