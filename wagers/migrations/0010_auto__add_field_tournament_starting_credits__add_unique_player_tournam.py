...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.starting_credits'
        db.add_column(u'wagers_tournament', 'starting_credits',
                      self.gf('django.db.models.fields.DecimalField')(default=10.0, max_digits=100, decimal_places=10),
                      keep_default=False)

        # Adding unique constraint on 'Player', fields ['tournament', 'user']
        db.create_unique(u'wagers_player', ['tournament_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['tournament', 'user']
        db.delete_unique(u'wagers_player', ['tournament_id', 'user_id'])

        # Deleting field 'Tournament.starting_credits'
        db.delete_column(u'wagers_tournament', 'starting_credits')
