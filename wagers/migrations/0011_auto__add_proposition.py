...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wagers_proposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('tournament', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wagers.Tournament'])),
            ('team_a', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('team_b', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal(u'wagers', ['Proposition'])


    def backwards(self, orm):
        # Deleting model 'Proposition'
        db.delete_table(u'wagers_proposition')
