...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposition.paid_on'
        db.add_column(u'wagers_proposition', 'paid_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposition.paid_on'
        db.delete_column(u'wagers_proposition', 'paid_on')
